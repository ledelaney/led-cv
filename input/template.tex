...
\fancyfoot[R]{\small{$date$ | page \thepage\ of 2}}
\fancyfoot[L]{\small{\href{https://github.com/ledelaney/rmd-cv/blob/master/printable-cv/printable-cv.pdf}{\textcolor{violet}{Click here for printer-friendly version}}.}}
