...
\fancyfoot[R]{\tiny{$date$ | page \thepage of 2}\\\small{Created with LaTeX and R Studio, \href{https://github.com/ledelaney/rmd-cv}{on the shoulders of giants}.}}
