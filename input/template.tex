...
\fancyfoot[R]{\tiny{$date$ | page \thepage\ of 2}\\\tiny{Created with LaTeX and R Studio, \href{https://github.com/ledelaney/rmd-cv}{\textcolor{violet}{on the shoulders of giants}}.}}
