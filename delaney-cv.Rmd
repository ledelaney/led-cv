...
orcid: 
programming: "R"
languages: "$\LLaTeX$, HTML & CSS, R Markdown"
software: "Adobe Illustrator, Microsoft Office Suite"
github: "ledelaney"
twitter: 
licenses: "Illinois Substitute Teaching, FCC Technician Class Radio" 
interests: "Conceptual understanding of evolutionary principles, `R` for undergraduate education, macroevolution, the evolution of plant breeding systems, data manipulation & visualization with `tidyverse`"
edu:
...
teachinghons:
  - {year: 2020, what: "Nominated for the Graduate Student Excellence in Teaching and Mentoring Award"}
...
otherhons:
  ...
  - {year: 2017, what: "Accepted to NSF-funded workshop on Bayesian analysis of macroevolutionary mixtures"}
  - {year: 2017, what: "Recipient of the Biological Sciences Department Travel Award"}
  - {year: 2017, what: "Accepted to \\href{https://www.arboretum.harvard.edu/tracing-evolution-form-function/}{microMORPH Plant Anatomy Summer Course} at Harvard University"}
...
presentations <- read_csv(file = "/Users/lucydelaney/rmd-cv/presentations.csv", col_names = T, na = c(NA, "", " "), trim_ws = T, skip_empty_rows = T) %>%
