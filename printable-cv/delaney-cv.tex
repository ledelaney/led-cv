...
Dissertation: \textit{How do we understand and explain natural selection?}\\
...
\subsection{\fontsize{12}{36}\selectfont \textit{In revision}}
\vspace{-2mm}
\begin{cslreferences}
\textbf{Delaney, Lucy E} \& Igić, B. The phylogenetic distribution and frequency of self-incompatibility in Fabaceae. \textit{Accepted by the International Journal of Plant Sciences}.
\end{cslreferences}
\vspace{-4mm}
