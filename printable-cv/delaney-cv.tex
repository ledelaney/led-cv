...
\vspace{4mm}
\leftskip 1.8em
\subsection{Evolution Education Research}
\vspace{2mm}

\textit{Natural Selection Does Not Come Naturally}

\begin{itemize}[label=$\mathwitch*$]
\item{\textbf{June 2021} \textit{upcoming} Annual Evolution Conference $\vert$ Virtual Talk} 
...
\textit{The Four Causes of Adaptation}

\begin{itemize}[label=$\mathwitch*$]
\item{\textbf{March 2021} Midwest Ecology and Evolution Conference $\vert$ Virtual Talk \hspace{0.3mm} \href{https://ledelaney.org/talks/meectalk/MEEC-slides.html}{\faImages} \href{https://github.com/ledelaney/03-21-MEEC}{\faGithub}}
\item{\textbf{January 2021} SABER West $\vert$ Virtual Roundtable \hspace{0.3mm} \href{https://ledelaney.org/talks/sabertalk/SABER-slides.html}{\faImages} \href{https://github.com/ledelaney/01-21-SABERwest}{\faGithub}}
\end{itemize}
\vspace{2mm}


\subsection{Flowering Plant Breeding Systems}
\vspace{2mm}

\textit{The Phylogenetic Distribution and Frequency of Self-Incompatibility in Fabaceae},\\ with Ramanauskas, K. \& Igić, B

\begin{itemize}[label=$\mathwitch*$]
\item{\textbf{July 2021} \textit{upcoming} Annual Meeting of the Botanical Society of America $\vert$ Virtual Talk}
%\hspace{0.3mm} \href{https://ledelaney.org/talks/meectalk/MEEC-slides.html}{\faImages} \href{https://github.com/ledelaney/03-21-MEEC}{\faGithub}}
\item{\textbf{July 2018} Annual Meeting of the Botanical Society of America $\vert$ Rochester, MN $\vert$ Poster \hspace{0.3mm} \href{https://ledelaney.org/static/posters/poster.png}{\faFileImage}}
\end{itemize}
\vspace{2mm}

\textit{Evolutionary Consequences of Plant Mating Systems}

\begin{itemize}[label=$\mathwitch*$]
\item{\textbf{August 2017} microMORPH Summer Course $\vert$ Arnold Aborteum, Harvard $\vert$ Talk \hspace{0.3mm} \href{https://www.dropbox.com/s/o7hcg5riw97wf9i/08-2017-microMORPH.pdf?dl=1}{\faImages}}
\end{itemize}
\vspace{2mm}
